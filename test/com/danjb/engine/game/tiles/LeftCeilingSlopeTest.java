...
import com.danjb.engine.game.tiles.LeftCeilingSlope;
...
public class LeftCeilingSlopeTest {
    ...
    public void testPointInSlope() {
        ...
        assertEquals(true, slope.isPointInSlopeRegion(Tile.WIDTH, 0));
        assertEquals(false, slope.isPointInSlopeRegion(Tile.WIDTH, Tile.HEIGHT));
